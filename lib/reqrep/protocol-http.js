...
exports.send = function(serviceInfo, command, payload, sendOptions) {
    ...
    let timeout = sendOptions.timeout || 1000 * 60 * 10;
        ...
        var postRequest = http.request(options, function(res) {
            ...
            res.on('end', function () {
                ...
                try {
                    ...
                    return reject({error: 'cannot-parse-payload-as-json', err: err, payload: payload, result: result, options: options});
                }
                resolve(jsonData);
            });
            res.on('error', function (err) {
                reject({err: err, options: options, payload: payload});
            });
    ...
    return {
        ...
        start: function() {
            ...
            var promise = new Promise(function(resolve, reject) {
                ...
                // set 10 minutes as the default timeout
                server.setTimeout(options.timeout || 1000 * 60 * 10);
